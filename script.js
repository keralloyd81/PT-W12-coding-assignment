...
// Function to load all recipes and display them
...
// Function to add a new recipe when the form is submitted
...
async function deleteRecipe(id) {
  // Send a DELETE request to remove a specific recipe by its ID
  await fetch(`${API_URL}/${id}`, {
    method: 'DELETE'
  });

  // Reload the recipe list to reflect the change
  fetchRecipes();
}

// Load all recipes when the page first opens
fetchRecipes();
